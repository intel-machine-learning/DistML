...
export SPARK_MEM=50g

export SPARK_JAVA_OPTS="$SPARK_JAVA_OPTS -Xmx50g -Xms50g -Xmn2g -XX:+UseParallelGC -XX:ParallelGCThreads=4 -XX:+PrintGCTimeStamps -XX:+PrintGCDetails -XX:MaxPermSize=1g " 
