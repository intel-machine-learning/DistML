...
//    var numsample=100;
//    var dim=3;
//    var x = Array.ofDim[Double](numsample,dim);
//    var label=new Array[Int](numsample);
//    var line = "";
//    for(i <- 0 to numsample-1) {
//      line = reader.readLine.trim
//      val values = line.split(",");
//      x(i)(0) = 1.0;
//      for (j <- 1 to dim-1) {
//        x(i)(j) = java.lang.Double.parseDouble(values(j-1));
//      }
//      label(i) = Integer.parseInt(values(dim-1));
//    }
//    var samples = new Array[DataItem](1);
//    samples(0) = new DataItem(x, label,numsample,dim);
//
//
