...
public class LDAModelWriter implements ModelWriter {
    ...
    public void writeModel(Model model, ServerDataBus dataBus) {
        for (String matrixName : model.dataMap.keySet()) {
            ...
            writeToFile(dict, matrixName, result, matrixName + ".txt", model);
        }
    }

    public static void writeToFile(Dictionary dict, String matrixName, Matrix m, String filePath, Model model) {
